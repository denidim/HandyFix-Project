    ...
    internal class ServicesSeeder : ISeeder
    {
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            var services = new[]
            {
                ...
                new { Slug = "pipe-repairs", Name = "Pipe Repairs", Description = "Replacing damaged copper, plastic, or lead piping to restore secure water flow.", Price = 120.00m, Duration = 90, CategoryId = plumbingCategory.Id },
                new { Slug = "shower-installation", Name = "Shower Installation", Description = "Full assembly and electrical/plumbing integration of power showers and mixers.", Price = 240.00m, Duration = 180, CategoryId = plumbingCategory.Id },
                new { Slug = "bathroom-plumbing", Name = "Bathroom Plumbing", Description = "Installing baths, basins, bidets, or replacing complete bathroom sanitaryware.", Price = 160.00m, Duration = 120, CategoryId = plumbingCategory.Id },
                new { Slug = "kitchen-plumbing", Name = "Kitchen Plumbing", Description = "Installing kitchen sinks, garbage disposals, and other kitchen plumbing fixtures and fittings.", Price = 150.00m, Duration = 120, CategoryId = plumbingCategory.Id },
                ...
                new { Slug = "radiator-trv-replacement", Name = "Radiator & TRV Replacement", Description = "Replacing an old radiator or upgrading manual valves to thermostatic radiator valves (TRVs) for better heating control.", Price = 120.00m, Duration = 90, CategoryId = plumbingCategory.Id },
                new { Slug = "outside-garden-tap-installation", Name = "Outside Garden Tap Installation", Description = "Fitting an external garden tap with a double-check valve, connected to the internal water supply.", Price = 120.00m, Duration = 90, CategoryId = plumbingCategory.Id },
                ...
                // Handyman Services
                new { Slug = "furniture-assembly", Name = "Furniture Assembly", Description = "Professional flat pack furniture assembly for wardrobes, beds, desks, and tables.", Price = 90.00m, Duration = 90, CategoryId = handymanCategory.Id },
                ...
                new { Slug = "painting-touch-ups", Name = "Painting Touch-Ups", Description = "Filling holes, sanding down, and repainting damaged walls, doors, or skirting boards.", Price = 120.00m, Duration = 120, CategoryId = handymanCategory.Id },
                new { Slug = "property-maintenance", Name = "Property Maintenance", Description = "Comprehensive handyman checkups and general repairs across multiple areas of the property in a single visit.", Price = 180.00m, Duration = 180, CategoryId = handymanCategory.Id },
                ...
                new { Slug = "gutter-clearing", Name = "Gutter Clearing", Description = "Clearing leaves and debris from gutters and downpipes to prevent overflow and water damage.", Price = 90.00m, Duration = 90, CategoryId = handymanCategory.Id },
            };
