...
{
    /// <inheritdoc />
    public partial class InitialBusinessModelsCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckoutSessionId = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    StatusId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BookingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilitySlots_IsDeleted",
                table: "AvailabilitySlots",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingImages_IsDeleted",
                table: "BookingImages",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingStatuses_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InquiryImages_IsDeleted",
                table: "InquiryImages",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentStatuses_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceImages_IsDeleted",
                table: "ServiceImages",
                column: "IsDeleted");
